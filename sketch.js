...
function setup() {
  ...
  ground = createSprite(camera.x-50,height-10,400,20);
  ...
  invisibleGround = createSprite(camera.x,height-10,400,10);
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(camera.x+width/2,height-30,10,40);
    //obstacle.debug = true;
